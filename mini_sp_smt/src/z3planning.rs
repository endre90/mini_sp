    ...
    pub fn new(result: &ParamPlanningResult,
        ...
        if !params.iter().all(|x| x.1) {
            ...
            if result.plan_found {
                ...
                println!("concat_level: {:?}", final_result.level);
                println!("concat_concat: {:?}", final_result.concat);
                println!("concat_plan_found: {:?}", final_result.plan_found);
                println!("concat_plan_lenght: {:?}", final_result.plan_length);
                println!("concat_time_to_solve: {:?}", final_result.time_to_solve);
                println!("concat_trace: ");
                ...
                println!("dpldsrt_level: {:?}", delooped_and_sorted.level);
                println!("dpldsrt_concat: {:?}", delooped_and_sorted.concat);
                println!("dpldsrt_plan_found: {:?}", delooped_and_sorted.plan_found);
                println!("dpldsrt_plan_lenght: {:?}", delooped_and_sorted.plan_length);
                println!("dpldsrt_time_to_solve: {:?}", delooped_and_sorted.time_to_solve);
                println!("dpldsrt_trace: ");
